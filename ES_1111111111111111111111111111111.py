...
if __name__ == "__main__":
    ...
    if st.session_state['authenticated'] == False:
        ...
        def create_new_session(reset_chat_state=False):
            """
            Consolidated session creation logic - eliminates redundancy
            Args:
            ...
            try:
                ...
                if token:
                    ...
                    # No token - create local session
                    new_session_id = str(uuid.uuid4())
                    print(f"Frontend: Created local session (no token): {new_session_id}")
                ...
                # Final fallback to local session creation
                new_session_id = str(uuid.uuid4())
        ...
        with st.sidebar:
            ...
            if st.button("New Session", use_container_width=True):
                # Use consolidated session creation function
